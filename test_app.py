...
class CastingAgencyTestCase(unittest.TestCase):
    ...
    def test_get_movies(self):
        res = self.client.get('/movies', headers=self.header_executive_director)
    ...
    def test_get_actors(self):
        res = self.client.get('/actors', headers=self.header_executive_director)
        data = json.loads(res.data)
    ...
    def test_post_movie(self):
        res = self.client.post('/movies', headers=self.header_executive_director, json = self.new_movie)
    ...
    def test_post_actor(self):
        res = self.client.post('/actors', headers=self.header_executive_director, json = self.new_actor)
        data =json.loads(res.data)
    ...
    def test_delete_movie(self):
        ...
        res = self.client.delete('/movies/'+str(id), headers=self.header_executive_director)
        data = json.loads(res.data)
    ...
    def test_delete_actor(self):
        ...
        res = self.client.delete('/actors/'+str(id), headers=self.header_executive_director)
        data = json.loads(res.data)
    ...
    def test_patch_actor(self):
        ...
        id = 3
        res = self.client.patch('/actors/'+str(id)+"/update",json = self.update_actor, headers= self.header_executive_director)
        data = json.loads(res.data)
    ...
    def test_patch_movie(self):
        ...
        id = 1 
        res = self.client.patch('/movies/'+str(id)+"/update", json = self.update_movie, headers= self.header_executive_director)
        data = json.loads(res.data)
    ...
    def test_400_error_post_actor(self):
        json_void = {}
        res = self.client.post('/actors',json=json_void,headers=self.header_executive_director)
        data = json.loads(res.data)
    ...
    def test_400_error_post_movie(self):
        json_void={}
        res = self.client.post('movies',json=json_void,headers=self.header_executive_director)
        data = json.loads(res.data)
    ...
    def test_422_error_post_actor(self):
        ...
        res = self.client.post('/actors',json=json_send,headers=self.header_executive_director)
        data = json.loads(res.data)
    ...
    def test_422_error_post_movie(self):
        ...
        res = self.client.post('/movies',json=json_send, headers=self.header_executive_director)
        data = json.loads(res.data)
    ...
    def test_404_error_patch_movie(self):
        id = 1000
        res = self.client.patch('/movies/'+str(id)+"/update", headers=self.header_executive_director)
        data = json.loads(res.data)
    ...
    def test_400_error_patch_movie(self):
        id = 1
        json_send = {}
        res = self.client.patch('/movies/'+str(id)+"/update",headers=self.header_executive_director, json=json_send)
        data = json.loads(res.data)
    ...
    def test_400_error_patch_actor(self):
        id = 1
        json_send = {}
        res = self.client.patch('/actors/'+str(id)+"/update",headers=self.header_executive_director, json=json_send)
        data = json.loads(res.data)
    ...
    def test_casting_assistant_post_actor(self):
        res = self.client.post('/actors', headers=self.header_casting_assistant, json = self.new_actor)
        data =json.loads(res.data)
    ...
    def test_casting_assistant_delete_actor(self):
        id = 7
        res = self.client.delete('/movies/'+str(id), headers=self.header_casting_assistant)
        data =json.loads(res.data)
    ...
    def test_casting_director_post_actor(self):
        res = self.client.post('/actors', headers=self.header_casting_director, json = self.new_actor)
        data =json.loads(res.data)
    ...
    def test_casting_director_patch_movie(self):
        ...
        res = self.client.patch('/movies/'+str(id)+"/update", json = update, headers= self.header_casting_director)
        data = json.loads(res.data)

        self.assertEqual(res.status_code, 200)
        self.assertEqual(data['success'], True)
        self.assertEqual(data['movie'].get('title'), update.get('title')) # Checking if the title is changed
        self.assertEqual(data['movie'].get('release_date'), update.get('release_date')) # Checking if the release_date is changed
    ...
    def test_casting_director_post_movie(self):
        ...
        res = self.client.post('/movies', headers=self.header_casting_director, json = movie)
        data = json.loads(res.data)
    ...
    def test_casting_director_delete_movie(self):
        ...
        res = self.client.delete('/movies/'+str(id), headers=self.header_casting_director)
        data = json.loads(res.data)
